 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class dt extends ct{constructor(t){if(super(t),this.it=F,t.type!==lt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===F||null==t)return this._t=void 0,this.it=t;if(t===W)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}dt.directiveName="unsafeHTML",dt.resultType=1;const ht=(t=>(...e)=>({_$litDirective$:t,values:e}))(dt),ut=n`
  :host {
          ...
          `:B`
            <div class="calling-points-zone">
              <div class="calling-points-scroll" style="transform: translateY(0px)">
                ${a.length>0?ht(function(t,e=3){if(!t||0===t.length)return"";const i=[];for(let s=0;s<t.length;s+=e)i.push(t.slice(s,s+e).join(" • "));return i.join("<br>")}(a)):B`<span style="visibility:hidden">—</span>`}
              </div>
            </div>
          `}
