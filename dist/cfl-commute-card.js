          ...
          `:B`
            <div class="calling-points-zone">
              <div class="calling-points-scroll" style="transform: translateY(0px)">
                ${a.length>0?B`${function(t,e=3){if(!t||0===t.length)return"";const i=[];for(let s=0;s<t.length;s+=e)i.push(t.slice(s,s+e).join(" • "));return i.join("<br>")}(a)}`:B`<span style="visibility:hidden">—</span>`}
              </div>
            </div>
          `}
